...
const FacilityCard = ({ id, name, address, postalCode, neighborhood, facilityType, amenities, services, onClick }: FacilityCard) => {

  const handleClick = () => {
    onClick({ id, name, address, postalCode, neighborhood, facilityType, amenities, services });
  };
